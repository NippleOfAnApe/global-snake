...
void Player::UpdateMovement()
{
    ...
    if (IsKeyDown(KEY_SPACE))
    {
        ...
        // }
        accelerating = true;
        mSnake->speed = (Vector2){currentSpeed.x * 20.0f, currentSpeed.y * 20.0f};
    }
...
void Player::DrawSnake()
{
    ...
    DrawCircleV((mSnake + i)->position, (mSnake + i)->size, (mSnake + i)->color);
...
//         // }
//         accelerating = true;
//         snake->speed = (Vector2){currentSpeed.x * 20.0f, currentSpeed.y * 20.0f};
//     }
